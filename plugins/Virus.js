...
conn.fakeReply(from, virtex1, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex2, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex3, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex4, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex5, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')} 
break
...
conn.fakeReply(from, virtex6, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex7, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')
conn.fakeReply(from, virtex8, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')}
break    
...
conn.fakeReply(from, virtex9, '0@s.whatsapp.net', '🔥 *By Maraya* 🔥', 'status@broadcast')}
break 
case 'virus8': case 'c8': case 'binario8': case 'traba8': case 'crash8': {
conn.fakeReply(from, virtex10, '0@s.whatsapp.net', '🔥 *By Maraya 🔥', 'status@broadcast')}
break    
}
